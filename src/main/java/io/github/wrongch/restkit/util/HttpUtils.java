...
import static io.github.wrongch.restkit.common.RestConstant.HTTP_DOWNLOAD_FILEPATH_PREFIX;
import static io.github.wrongch.restkit.common.RestConstant.HTTP_FILE_DOWNLOAD_DIRECTORY;
import static io.github.wrongch.restkit.common.RestConstant.HTTP_FILE_PREFIX;
import static io.github.wrongch.restkit.common.RestConstant.HTTP_P12_PASSWD;
import static io.github.wrongch.restkit.common.RestConstant.HTTP_P12_PATH;
import static io.github.wrongch.restkit.common.RestConstant.HTTP_TIMEOUT;
...
public class HttpUtils {
    ...
    public static RequestInfo request(io.github.wrongch.restkit.restful.http.HttpRequest req) {
    ...
    private static RequestInfo doRequest(io.github.wrongch.restkit.restful.http.HttpRequest req) {
        ...
        try (CloseableHttpClient httpClient = createHttpClient(req);
            ...
            if (downloadFile != null) {
                return new RequestInfo(req, new io.github.wrongch.restkit.restful.http.HttpResponse(response, HTTP_DOWNLOAD_FILEPATH_PREFIX + " " + downloadFile.getPath()), hostAddress, (System.currentTimeMillis() - startTs));
            }
    ...
    private static HttpRequestBase getRequest(io.github.wrongch.restkit.restful.http.HttpRequest req) {
...
//                    url = url.replaceFirst("\\{(" + key + "[\\s\\S]*?)}", v);
    ...
    private static CloseableHttpClient createHttpClient(io.github.wrongch.restkit.restful.http.HttpRequest req) {
    ...
    private static File tryDownloadFile(io.github.wrongch.restkit.restful.http.HttpRequest req, CloseableHttpResponse response) throws IOException {
        try {
    ...
    private static File doDownloadFile(io.github.wrongch.restkit.restful.http.HttpRequest req, CloseableHttpResponse response) throws IOException {
