...
根据扩展点：`io.github.wrongch.restkit.restful.ep.LanguageResolverProvider`
...
<idea-plugin>
    ...
    <extensions defaultExtensionNs="io.github.wrongch.restkit">
        ...
        <languageResolver implementation="io.github.wrongch.restkit.feature.javaimpl.language.JavaLanguageResolverProvider"/>
    </extensions>
</idea-plugin>
```
