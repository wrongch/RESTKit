...
根据扩展点：`io.github.wrongch.restkit.restful.ep.RestClientProvider`
...
以支持Dubbo请求示例，完整代码查阅：[RESTKit-Dubbo](https://github.com/wrongch/RESTKit-Dubbo)
...
<idea-plugin>
    ...
    <extensions defaultExtensionNs="io.github.wrongch.restkit">
        ...
        <restClient implementation="io.github.wrongch.restkit.ext.dubbo.DubboClient$DubboClientProvider"/>
    </extensions>
</idea-plugin>
```
